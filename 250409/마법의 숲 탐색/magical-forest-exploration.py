...
def move(pos,exit_d):
    ...
    while pos[0]+1<R+1 :
        ...
        #서쪽이동 
        elif prev!=1 and w[1]-1>0 and forest[n[0]][n[1]-1] == 0 and forest[w[0]][w[1]-1] == 0 and forest[s[0]][s[1]-1]==0:
        ...
        #동쪽이동
        elif prev!=3 and e[1]+1<C and forest[n[0]][n[1]+1] == 0 and forest[e[0]][e[1]+1] == 0 and forest[s[0]][s[1]+1]==0:
            forest[exit[0]][exit[1]] = forest[pos[0]][pos[1]]
            exit_d = (exit_d+1)%4
            exit = (pos[0]+direction[exit_d][0],pos[1]+direction[exit_d][1])
            forest[exit[0]][exit[1]] = -forest[pos[0]][pos[1]]
